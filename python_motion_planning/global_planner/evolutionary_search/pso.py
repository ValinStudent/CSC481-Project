...
class PSO(EvolutionarySearcher):
    ...
    def __init__(self, start: tuple, goal: tuple, env: Env, heuristic_type: str = "euclidean", 
        n_particles: int = 100, point_num: int = 5, w_inertial: float = 1.0,
        w_cognitive: float = 1.0, w_social: float = 1.0, max_speed: int = 2,
        max_iter: int = 50, init_mode: int = GEN_MODE_RANDOM) -> None:
